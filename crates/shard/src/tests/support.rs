...
use crate::bytes::{align_to, usize_from_u64, write_string, write_u32, write_u64};
use crate::{
...
pub(super) fn unique_temp_dir() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("cogentlm-shard-test-{}-{id}", std::process::id()))
}
