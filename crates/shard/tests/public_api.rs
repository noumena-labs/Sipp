...
//!
//! Covers externally visible cache policy, metadata inspection, detection, and
//! split planning/writing behavior with deterministic in-memory GGUF fixtures.

use cogentlm_shard::{
    detect_model_from_gguf_bytes, inspect_gguf_metadata, plan_gguf_split, split_gguf, AssetRole,
    BrowserCacheLayout, BrowserCachePolicy, GgufError, GgufReadAt, GgufShard, GgufShardSink,
    GgufSplitManifest, GgufSplitOptions, ModelDetectionMethod,
};
