# CogentLM Rust Library

`crates/cogentlm` is the public Rust crate published as `cogentlm`. It is the
...
The crate exposes the high-level `CogentClient` API at the root plus the
