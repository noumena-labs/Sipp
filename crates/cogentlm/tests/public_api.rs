//! Integration tests for the `cogentlm` crate-level public API.
//!
...
mod client_api {
    use cogentlm::{EndpointCapabilities, EndpointDescriptor, EndpointRef, GatewayEndpointConfig};
    ...
    fn gateway_descriptor_is_registered_through_add_contract() {
        ...
        assert_eq!(
            ...
            cogentlm::core::CapabilitySupport::Unknown
        );
    }
}
