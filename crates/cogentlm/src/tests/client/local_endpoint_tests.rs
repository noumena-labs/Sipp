//! Tests the `local_endpoint` module in `cogentlm`.
//!
...
use super::*;
use crate::client::{CogentTextOptions, LocalEmbedOptions, LocalTextOptions};
...
fn local_text_runtime_errors_are_wrapped() {
    ...
    assert!(matches!(
        error,
        CogentError::Local(crate::error::Error::RuntimeCommand(message))
