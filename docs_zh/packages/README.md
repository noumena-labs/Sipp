...
| [Browser](browser.md) | `npm install sipp` | 浏览器本地 GGUF 推理、WebGPU/WASM 运行时、浏览器端网关客户端。 |
| [Node.js](node.md) | `npm install sipp-server` | Node 服务器进程、路由处理器、后端服务。 |
| [Python](python.md) | `pip install sipp` | Python 服务、脚本、网关客户端。 |
| [Rust](rust.md) | `cargo add sipp` | Rust 应用和服务。 |
