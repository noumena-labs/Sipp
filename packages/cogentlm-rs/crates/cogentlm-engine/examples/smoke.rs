...
use cogentlm_engine::engine::{
    ...
    NativeRuntimeConfig, QueryOptions, RequestResult, SamplingRuntimeConfig,
};
use cogentlm_engine::lifecycle::{
    model_source_from_path, BackendPreference, ModelLoadOptions, ModelService, StatsMode,
};
...
impl StreamCapture {
    fn record(&mut self, batch: &cogentlm_engine::engine::TokenBatch) {
