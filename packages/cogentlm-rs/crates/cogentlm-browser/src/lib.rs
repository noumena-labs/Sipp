...
#[cfg(target_family = "wasm")]
use cogentlm_core::runtime::config::NativeRuntimeConfig;
#[cfg(target_family = "wasm")]
use cogentlm_core::runtime::request::{
...
#[cfg(target_family = "wasm")]
use cogentlm_core::runtime::{InferenceRuntime, RequestStepResult, SchedulerBurstResult};
#[cfg(target_family = "wasm")]
use cogentlm_core::{backend_observability_json, set_llama_log_quiet};
...
fn runtime_metrics_from_core(
    metrics: cogentlm_core::runtime::metrics::RuntimeObservabilityMetrics,
