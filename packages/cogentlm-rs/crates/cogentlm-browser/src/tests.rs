...
#[test]
fn copy_required_capacity_detects_overflow() {
    assert_eq!(copy_required_capacity_len(usize::MAX), None);
}

#[test]
fn saturating_usize_to_i32_clamps_large_values() {
    assert_eq!(saturating_usize_to_i32(4), 4);
