  ...
  private readRuntimeObservabilityViaCall(
    ...
    try {
      ...
      return withDerivedObservabilityMetrics({
        ...
        nativeSchedulerTickMs: this.module.HEAPF64[f64Offset + 9],
        nativeSchedulerAdmitMs: this.module.HEAPF64[f64Offset + 10],
        nativeSchedulerFinalizeMs: this.module.HEAPF64[f64Offset + 11],
        nativeSchedulerCommitMs: this.module.HEAPF64[f64Offset + 12],
        nativePolicyPrepareMs: this.module.HEAPF64[f64Offset + 13],
        nativePolicyPlanMs: this.module.HEAPF64[f64Offset + 14],
        nativeBatchBuildMs: this.module.HEAPF64[f64Offset + 15],
        nativeLlamaDecodeWallMs: this.module.HEAPF64[f64Offset + 16],
        nativeSynchronizeMs: this.module.HEAPF64[f64Offset + 17],
        nativeKvUpdateMs: this.module.HEAPF64[f64Offset + 18],
        nativeSamplerWallMs: this.module.HEAPF64[f64Offset + 19],
        nativeTokenEmitMs: this.module.HEAPF64[f64Offset + 20],
        nativePrefixCacheMs: this.module.HEAPF64[f64Offset + 21],
        nativeObservabilityMs: this.module.HEAPF64[f64Offset + 22],
        ...
        nativePolicyTickCount: this.module.HEAP32[i32Offset + 14],
        nativeSchedulerTickCount: this.module.HEAP32[i32Offset + 15],
      });
    } finally {
