...
struct GenerateRequest {
  ...
  double attributed_native_policy_prepare_ms = 0.0;
  double attributed_native_policy_plan_ms = 0.0;
  double attributed_native_batch_build_ms = 0.0;
  double attributed_native_llama_decode_wall_ms = 0.0;
  double attributed_native_synchronize_ms = 0.0;
  double attributed_native_kv_update_ms = 0.0;
  double attributed_native_sampler_wall_ms = 0.0;
  double attributed_native_token_emit_ms = 0.0;
  double attributed_native_prefix_cache_ms = 0.0;
  double attributed_native_observability_ms = 0.0;
  int32_t attributed_prompt_eval_tokens = 0;
  int32_t attributed_decode_eval_count = 0;
  int32_t attributed_sample_count = 0;
  int32_t attributed_native_policy_tick_count = 0;
