...
export const COURTYARD_SCENARIO: ScenarioSeed = {
  ...
  objects: [
    ...
    },
    {
      ...
      kind: 'crate',
      label: 'left crate',
      description: 'A heavy supply crate that blocks the inside lane on the left side.',
      position: { x: -3, z: -1 },
      blocksMovement: true,
    ...
    },
    {
      ...
      kind: 'crate',
      label: 'right crate',
      description: 'A heavy supply crate that forces runners to route around the right side.',
      position: { x: 3, z: 1 },
      blocksMovement: true,
      collisionRadius: 0.65,
      tags: ['obstacle'],
    ...
    },
    {
      ...
      kind: 'rock',
      label: 'north rock',
      description: 'A jagged rock outcrop near the top of the courtyard that pinches the lane.',
      position: { x: -2, z: 3 },
      blocksMovement: true,
    ...
    },
    {
      ...
      kind: 'rock',
      label: 'south rock',
      description: 'A low boulder near the goal approach that can trap a crowded chase.',
      position: { x: 2, z: -3 },
      blocksMovement: true,
      collisionRadius: 0.55,
      tags: ['obstacle'],
