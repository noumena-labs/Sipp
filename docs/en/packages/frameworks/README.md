...
Use the browser package, `@sipphq/sipp`, when inference runs in the browser or when
browser code calls a gateway. Use the Node package, `@sipphq/sipp-server`, only in
